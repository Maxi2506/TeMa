...
public class Cv_HabilidadesServicio {
    ...
    private Cv_HabilidadesDTO convertirADTO(Cv_Habilidades entidad) {
        ...
        if (entidad.getHabilidades() != null) {
            ...
            // Aquí extraemos el nombre del Enum
            dto.setNombreHabilidad(entidad.getHabilidades().getNombre().name());
        }

        // NO intentes asignar "contenido" o "fechaCreate" aquí,
        // porque tu clase DTO no tiene esos campos.
